...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Rate limiting simple basé sur l'UID (optionnel, améliorable)
    // Pour l'instant on fait confiance au throttle côté client
    ...
    // Appel à l'API Claude (Haiku pour le coût/vitesse)
